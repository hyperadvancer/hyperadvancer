...
- The future of streaming might just be [coding competitions](https://www.linkedin.com/pulse/future-streaming-might-just-coding-competitions-bart-collet-ypnue)
- LLMs are [useless](https://www.linkedin.com/pulse/llms-useless-can-only-generate-answers-bart-collet-ddure). They can only generate answers.
- Conversations in code giving humans [space to innovate](https://www.linkedin.com/pulse/conversations-code-giving-humans-space-innovate-bart-collet-k19bf/)
...
- The future of streaming might just be [coding competitions](https://medium.com/@bart.collet/the-future-of-streaming-might-just-be-coding-competitions-16a854cea9c2)
- LLMs are [useless](https://medium.com/@bart.collet/llms-are-useless-they-can-only-generate-answers-722ed3cf9542). They can only generate answers.
- Conversations in code giving humans [space to innovate](https://medium.com/@bart.collet/conversations-in-code-giving-humans-space-to-innovate-54ba28a15b0d)

Over the past month, we've been adding about one longevity event per day to the [Longevity Events Calendar.](https://longevents.hyperadvancer.com/) The one you won't want to miss? The [Healthusiasm Labs Business Day](https://events.healthusiasmlab.com/). Need some lateral thinking? Give the [Innovation Roulette](https://roulette.hyperadvancer.com/) a spin for inspiration that's genuinely out-of-the-box. And if you've got an outrageously ambitious idea you're ready to pitch to an international audience, click [here](https://mostinnovative.hyperadvancer.com/) to apply.
